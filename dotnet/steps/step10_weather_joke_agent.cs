...
agent.PromptAddSection("Personality",
    ...
    + "You have a warm, upbeat personality and you genuinely enjoy helping people.");
...
agent.SetPostPrompt("Summarize this conversation in 2-3 sentences. Note what the caller asked about and how the interaction went.");
